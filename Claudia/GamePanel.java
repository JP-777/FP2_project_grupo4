    ...
    public void keyPressed(KeyEvent e) {
        ...
        public class GamePanel extends JPanel implements KeyListener {
            ...
            public GamePanel(String trackImagePath, String player1Path, String player2Path, String player3Path) {
                ...
                // Cargar imágenes sin redimensionar inicialmente
                this.trackImage = new ImageIcon(trackImagePath).getImage();
                this.player1Image = new ImageIcon(player1Path).getImage();
                this.player2Image = new ImageIcon(player2Path).getImage();
                this.player3Image = new ImageIcon(player3Path).getImage();
            ...
            private void updateComponentPositions() {
                ...
                // Redimensionar imágenes para ajustarlas al tamaño del panel
                Image scaledTrackImage = trackImage.getScaledInstance(width, height, Image.SCALE_SMOOTH);
                ImageIcon trackIcon = new ImageIcon(scaledTrackImage);
                setBackgroundImage(trackIcon);
        
                Image scaledPlayer1Image = player1Image.getScaledInstance(playerWidth, playerHeight, Image.SCALE_SMOOTH);
                ImageIcon player1Icon = new ImageIcon(scaledPlayer1Image);
                player1.setIcon(player1Icon);
        
                Image scaledPlayer2Image = player2Image.getScaledInstance(playerWidth, playerHeight, Image.SCALE_SMOOTH);
                ImageIcon player2Icon = new ImageIcon(scaledPlayer2Image);
                player2.setIcon(player2Icon);
        
                Image scaledPlayer3Image = player3Image.getScaledInstance(playerWidth, playerHeight, Image.SCALE_SMOOTH);
                ImageIcon player3Icon = new ImageIcon(scaledPlayer3Image);
                player3.setIcon(player3Icon);
            ...
            private void setBackgroundImage(ImageIcon imageIcon) {
                ...
                this.trackImage = imageIcon.getImage();
                repaint(); // Redibuja el panel para mostrar la nueva imagen de fondo
            }
...
// Inicialización del panel de juego con rutas de imágenes
GamePanel gamePanel = new GamePanel(
    "Claudia/imagenes/pista.jpg", 
    "Claudia/imagenes/jug1.jpg", 
    "Claudia/imagenes/jug2.jpg", 
    "Claudia/imagenes/jug3.jpg"
);
